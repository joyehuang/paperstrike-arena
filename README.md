...
Reloading now shows separate moving magazines, a support hand, slide/bolt action and shotgun shells, paired with mechanical samples and a progress indicator. Ammo transfers once at completion; switching weapons cancels the reload. Reload animation leaves the aim camera unchanged.
